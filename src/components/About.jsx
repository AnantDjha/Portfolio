...
import cv from "../assets/AnantCv (4).pdf"
            ...
            <div className="firstDiv" >
                <div className="about">
                    <div ref={ref}><motion.h1 variants={{ visible: { left: "0", opacity: 0.8 } }} initial={{ position: "relative", top: "5rem", opacity: 0 }} animate={mainControl} transition={{ duration: 0.4, delay: 0.1, ease: "easeInOut" }}>About Me</motion.h1>
                        ...
                        <motion.span variants={{ visible: { left: "0", opacity: 1 } }} initial={{ position: "relative", top: "5rem", opacity: 0 }} animate={mainControl} transition={{ duration: 0.4, delay: 0.6, ease: "easeInOut" }}><a href={cv} download={true} >Download CV</a></motion.span>
                    </div>
                </div>
                <div className="photo">
