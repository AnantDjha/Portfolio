        ...
        <div id="about" className="aboutMain" onClick={() => { 
            ...
            <div className="firstDiv" >
                <div className="about">
                    ...
                    <motion.span variants={{visible:{ left: "0", opacity: 1 }}} initial={{ position: "relative", top: "5rem", opacity: 0 }} animate={mainControl} transition={{ duration: 0.3,delay:0.9,ease: "easeInOut"}}><a href={cv} download = "cv">Download CV</a></motion.span>
                    </div>
                </div>
                <div className="photo">
